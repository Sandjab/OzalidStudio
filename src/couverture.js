...
const SCHEMA = [
  ...
  },
  {
    ...
    champs: [
      ...
      { chemin: 'cadre.filet1_epaisseur', libelle: 'Épaisseur externe', type: 'nombre', min: 0.05, max: 2, pas: 0.05, unite: '% côté court' },
      { chemin: 'cadre.decroche', libelle: 'Décroché', type: 'nombre', min: 0, max: 12, pas: 0.1, unite: '% côté court' },
      { chemin: 'cadre.filet2_couleur', libelle: 'Filets internes', type: 'couleur' },
      { chemin: 'cadre.filet2_epaisseur', libelle: 'Épaisseur interne', type: 'nombre', min: 0.05, max: 2, pas: 0.05, unite: '% côté court' },
      { chemin: 'cadre.ecart', libelle: 'Écart des deux filets', type: 'nombre', min: 0, max: 6, pas: 0.1, unite: '% côté court' },
    ],
  },
  style('auteur', 'Auteur'),
  {
